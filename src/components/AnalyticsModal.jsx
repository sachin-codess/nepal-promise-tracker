  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <h2 className="tl-title">Promise analytics</h2>
        <p className="tl-sub">{total} promises tracked</p>

        <div className="an-wrap">
          <svg width="220" height="220" viewBox="0 0 220 220" role="img" aria-label="Status breakdown donut chart">
            ...
            <text x="110" y="126" textAnchor="middle" className="an-center-label">promises</text>
          </svg>
          ...
          <ul className="an-legend">
            {segments.map((s) => (
              <li key={s.key} className="an-legend-item">
                ...
                <span className="an-legend-label">{s.meta.label}</span>
