...
export const STRINGS = {
  en: {
    ...
    analytics: "Analytics",
    lbBtn: "Scores",
    lbTitle: "Accountability Scores",
    lbIntro: "Parties and politicians ranked by a weighted score across every recorded promise. Scores move as promises are updated.",
    lbParties: "Parties",
    lbPoliticians: "Politicians",
    lbResolution: "Resolution rate",
    lbTracked: "tracked",
    lbProvisional: "Provisional",
    confHigh: "High confidence",
    confMedium: "Medium confidence",
    confLow: "Low confidence",
    lbFootnote: "Score = kept (10) + in-progress on-time (6) + overdue (3) + broken (0), as a share of the maximum. Resolution rate = kept of those resolved. Parties with few recorded promises are marked provisional.",
    map: "Map",
  ...
  ne: {
    ...
    analytics: "तथ्याङ्क",
    lbBtn: "अंक",
    lbTitle: "जवाफदेहिता अंक",
    lbIntro: "दर्ता भएका हरेक वाचाको आधारमा तौलिएको अंकद्वारा दल र नेताहरूको क्रमबद्धता। वाचा अद्यावधिक हुँदा अंक परिवर्तन हुन्छ।",
    lbParties: "दलहरू",
    lbPoliticians: "नेताहरू",
    lbResolution: "पूरा हुने दर",
    lbTracked: "दर्ता",
    lbProvisional: "अस्थायी",
    confHigh: "उच्च विश्वसनीयता",
    confMedium: "मध्यम विश्वसनीयता",
    confLow: "न्यून विश्वसनीयता",
    lbFootnote: "अंक = पूरा भएको (१०) + समयमै प्रगतिमा (६) + म्याद नाघेको (३) + पूरा नभएको (०), अधिकतमको अनुपातमा। पूरा हुने दर = परिणाम आइसकेकामध्ये पूरा भएका। थोरै वाचा दर्ता भएका दललाई अस्थायी अंकित गरिएको।",
    map: "नक्सा",
